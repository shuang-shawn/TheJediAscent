...
public class GrievousAnimationComponent extends AnimationComponent {
    private static final String IDLE_ASSET = "GrievousIdle.png";
    private static final String ATTACK_ASSET = "GrievousAttack.png";
    ...
    public GrievousAnimationComponent() {
